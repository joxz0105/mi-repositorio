...
/* This config.h is shared by every ABI, so it cannot hardcode 4: on the LP64
   targets (arm64-v8a, x86_64) a long is 8 bytes, and alMain.h picks its 64-bit
   integer typedef off this value. */
#ifdef __LP64__
