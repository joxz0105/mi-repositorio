...
/* Upstream hardcoded this to 4, which is wrong on arm64-v8a and x86_64 and
   silently corrupts every SDL pointer-sized type. Every other SDL_config_*.h
   makes this conditional; the Android one never did. */
#ifdef __LP64__
